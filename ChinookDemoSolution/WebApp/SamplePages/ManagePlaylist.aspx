<%@ Page Title="OLTP Playlist" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManagePlaylist.aspx.cs"
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <%-- In production, make the following 2 labels visible="false" --%>
            ...
            <asp:HiddenField ID="TracksBy" runat="server" Visible="true" />
    ...
    <asp:ObjectDataSource ID="TrackSelectionListODS" runat="server"
        ...
        <SelectParameters>
            <%-- PropertyName needs to be "Text" if value comes from a label, and "Value" if it comes from a hidden field --%>
